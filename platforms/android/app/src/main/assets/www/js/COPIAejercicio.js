...
var BoardHelpers = {
    ...
    Animation = function(J) {
        ...
        function L() {  // ESTA FUNCION AGREGA TODOS LOS EVENTOS
            ...
            document.querySelector("#btnDeleteEjercicio").addEventListener("click", G().resetAnimationButtonClick_ap, !1);
            document.querySelector("#mainOpenEjercicios").addEventListener("click", G().resetAnimationButtonClick_ap, !1);    
            $("#mainOpenEjercicios").click(function(){
                G().resetAnimationButtonClick_ap;
            });      
            
            document.querySelector("#addEjercicioAnimation").addEventListener("click", G().resetAnimationButtonClick_ap, !1); //G().resetAnimationButtonClick
        ...
        function G() { // FUNCIONES EXTRAS PARA LOS BOTONES
            qa || (qa = {
                ...
                clearAnimationButtonClick: function(a) {
                    a = _projectTexts.get();
                    app.dialog.confirm(a.are_you_sure + "<br>" + a.ensure_you_got_animation_links, function () { A_ap(); });
                },
                resetAnimationButtonClick: function(a) { $("#lblTitleHeader").html(""); A(); },
                resetAnimationButtonClick_ap: function(a) { $("#lblTitleHeader").html(""); A_ap(); },
        ...
        function v() {  // ESTA FUNCION SE EJECUTA CUANDO AÑADES UN NUEVO FRAME
            ...
            for (c in b.elements){
                if (b.elements.hasOwnProperty(c)) {
                    var d = {
                        x: b.elements[c].pos.e.x,  //+ 0.0380952380952
        ...
        function A() { // ESTA FUNCION REINICIA TODO LIMPIA
            ...
            showElement("#" + c);
            p(!0);
            O.reset(); // ESTO RESETEA LOS ICONOS DE LA PANTALLA
            S = 5;
            m(S);
            Y = !0;
            removeClass(document.querySelector("#animation_buttons_panel #animation_repeat"), "button-selected");
